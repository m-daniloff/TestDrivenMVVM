...
namespace FriendStorage.UITests.ViewModel
{
    public class MainViewModelTests
    {
        ...
        List<Mock<IFriendEditViewModel>> _friendEditViewModelMocks;
        ...
        public MainViewModelTests()
        {
            ...
            _eventAggregatorMock.Setup(e => e.GetEvent<OpenFriendEditViewEvent>())
                .Returns(_openFriendEditViewEvent);
            _eventAggregatorMock.Setup(e => e.GetEvent<FriendDeletedEvent>())
        ...
        [Fact]
        public void ShouldAddFriendEditViewModelAndLoadWithIdNullAndSelectIt()
        {
